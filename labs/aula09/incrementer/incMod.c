...
/*  ./incrementer -t 4  (4 threads, cada uma a fazer 1000 incrementos)
    BIG BIG ~1000
    SMALL BIG ~4000
    SMALL SMALL ~1000 e ~4000 (mt aleatorio mas mais para o 4000)
    BIG BIG ~1000 E ~4000 (mt aleatorio mas mais para o 1000)
*/